...
localparam IO_PUMP_ON_bit               = 13;  // Turning on the PUMP 
localparam IO_PUMP_ALARM_bit            = 14; // Turning on the PUMP ALARM in case of some error 
localparam IO_PUMP_PRESSURE_bit         = 15; // Turning on the PUMP ALARM in case of some error 
